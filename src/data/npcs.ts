...
export const NPC_DATA: NPCData[] = [
  ...
  },
  {
    ...
    name: 'Rosa',
    role: 'faithful',
    personality: 'Cozinheira supersticiosa. Vê presságios em tudo, mas ouve cada conversa da casa.',
    trustLevel: 55,
    suspicionLevel: 30,
    color: 0x88d8c0,
    startRoom: 'kitchen',
  ...
  },
  {
    ...
    name: 'Túlio',
    role: 'faithful',
    personality: 'Mordomo formal. Conhece cada corredor da mansão e nunca esquece um rosto.',
    trustLevel: 50,
    suspicionLevel: 20,
    color: 0xb8b8d8,
    startRoom: 'corridor',
